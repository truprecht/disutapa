...
def test_extract():
    ...
    assert __extract_tree(tree[(0,0,1)], "VP", {4}) == Tree((5, rule("VP|<>", sdcp_clause(None, 0), ())), [])
    assert __extract_tree(tree[(0,0)], "VP", set()) == Tree((4, rule("VP", sdcp_clause("VP", 2), ("L-VP", "VP|<>"))), [
        Tree((0, rule("L-VP", sdcp_clause(None, 0), ())), []),
        Tree((5, rule("VP|<>", sdcp_clause(None, 0), ())),[])
    ])
    
    assert list(extract(tree)) == [
        rule("L-VP", sdcp_clause(None, 0), ()),
        rule("ROOT", sdcp_clause("SBAR+S", 2), ("VP", "NP")),
...
def test_corpus_extractor():
    ...
    assert list(c.rules) == [
        ...
        rule("NP", sdcp_clause("NP", 0), ()),
        rule("VP", sdcp_clause("VP", 1), ("VP",)),
        rule("VP", sdcp_clause("VP", 2), ("L-VP", "VP|<VBN,RP>")),
        rule("VP|<VBN,RP>", sdcp_clause(None, 0), ()),
    ]
...
def test_derivations():
    ...
    assert __extract_tree(t, "ROOT", set()) == Tree(
        (1, rule("SBAR+S", sdcp_clause("SBAR+S", 2), ("VP", "NP"))), [
            Tree((3, rule("VP", sdcp_clause("VP", 1), ("VP",))), [
                Tree((4, rule("VP", sdcp_clause("VP", 2), ("L-VP", "VP|<>"))), [
                    Tree((0, rule("L-VP", sdcp_clause(None, 0), ())), []),
                    Tree((5, rule("VP|<>", sdcp_clause(None, 0), ())), [])
                ])
            ]),
            Tree((2, rule("NP", sdcp_clause("NP", 0), ())), [])
        ]
    )
    ...
    assert __extract_tree(t, "ROOT", set()) == Tree(
        (7,rule("ROOT", sdcp_clause("ROOT", 1), ("DU",))), [
            Tree((2, rule("DU", sdcp_clause("DU", 2), ("PP", "DU|<>"))), [
                Tree((1, rule("PP", sdcp_clause("PP", 1), ("L-PP",))), [
                    Tree((0, rule("L-PP", sdcp_clause(None, 0), ())), [])
                ]),
                Tree((3, rule("DU|<>", sdcp_clause(None, 1, push_idx=0), ("SMAIN",))), [
                    Tree((4, rule("SMAIN", sdcp_clause("SMAIN", 2), ("NP", "PP"))), [
                        Tree((8, rule("NP", sdcp_clause("NP", 0), ())), []),
                        Tree((5, rule("PP", sdcp_clause("PP", 1, push_idx=0), ("NP",))), [
                            Tree((6, rule("NP", sdcp_clause("NP", 0), ())), [])
                        ])
                    ])
                ])
            ])
