...
from sdcp.reranking.classifier import FeatureExtractor, TreeRanker, max_margin_loss, perceptron_loss, softmax_loss
...
def test_ranker():
    ...
    ranker.fit(20, softmax_loss, devset=list(zip(goldindices, silvertrees)))
